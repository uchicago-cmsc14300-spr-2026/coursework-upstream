...
Test(hw2_negate_colors, negate_colors01)
{
  rgb colors[]  = {0X732AB4};
...
Test(hw2_negate_colors, negate_colors02)
{
...
Test(hw2_negate_colors, negate_colors03)
{
...
Test(hw2_connect_rgb_arrays, connect_rgb_arrays01)
{
...
Test(hw2_connect_rgb_arrays, connect_rgb_arrays02)
{
...
Test(hw2_connect_rgb_arrays, connect_rgb_arrays03)
{
...
Test(hw2_connect_rgb_arrays, connect_rgb_arrays04)
{
...
Test(hw2_connect_rgb_arrays, connect_rgb_arrays05)
{
  rgb colors1[] = {0X994328, 0X221827, 0X16A409, 0XA49BCD};
...
Test(hw2_sift_down, sift_down01)
{
...
Test(hw2_sift_down, sift_down02)
{
...
Test(hw2_sift_down, sift_down03)
{
...
Test(hw2_sift_down, sift_down04)
{
...
Test(hw2_sift_down, sift_down05)
{
  timestamp dates[] = {20250201000000, 20250202000000, 20250301000000,
    20250203000000, 20250204000000, 20250302000000, 20250303000000,
    20250205000000};
...
Test(hw2_sift_down, sift_down06)
{
  timestamp dates[] = {20250201000000, 20250203000000, 20250301000000,
    20250202000000, 20250204000000, 20250302000000, 20250303000000,
    20250205000000};
...
Test(hw2_sift_down, sift_down07)
{
  timestamp dates[] = {20250201000000, 20250203000000, 20250301000000,
...
Test(hw2_heapsort_dates, heapsort_dates01)
{
...
Test(hw2_heapsort_dates, heapsort_dates02)
{
...
Test(hw2_heapsort_dates, heapsort_dates03)
{
...
Test(hw2_heapsort_dates, heapsort_dates04)
{
...
Test(hw2_heapsort_dates, heapsort_dates05)
{
...
Test(hw2_heapsort_dates, heapsort_dates06)
{
...
Test(hw2_heapsort_dates, heapsort_dates07)
{
  timestamp dates[] = {20220304050607, 20260708091011, 20280910111213,
...
Test(hw2_distinct_dates, distinct_dates01)
{
...
Test(hw2_distinct_dates, distinct_dates02)
{
...
Test(hw2_distinct_dates, distinct_dates03)
{
...
Test(hw2_distinct_dates, distinct_dates04)
{
...
Test(hw2_distinct_dates, distinct_dates05)
{
...
Test(hw2_distinct_dates, distinct_dates06)
{
...
Test(hw2_distinct_dates, distinct_dates07)
{
